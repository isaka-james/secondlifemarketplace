...
%>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href='login.jsp?id=<%= id_product %>'><button class="dropdown-item" type="button">Sign in</button></a>
                            <a href='create.jsp?id=<%= id_product %>'><button class="dropdown-item" type="button">Sign up</button></a>
                        </div>
