...
String sql_count_users = "SELECT COUNT('items') FROM items";
PreparedStatement statement_user_count = connection.prepareStatement(sql_count_users);
ResultSet resultSet_user_count = statement_user_count.executeQuery();
String columnCountuser = null;
            // Retrieve the count value
            if (resultSet_user_count.next()) {
                 columnCountuser = resultSet_user_count.getString(1);
            }
    
sql_count_users = "SELECT COUNT('users') FROM users";
statement_user_count = connection.prepareStatement(sql_count_users);
resultSet_user_count = statement_user_count.executeQuery();
String columnCountitem = null;
            // Retrieve the count value
            if (resultSet_user_count.next()) {
                 columnCountitem = resultSet_user_count.getString(1);
            }
%>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><%= columnCountuser %></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                ...
                                <h6 class="mb-0"><%= columnCountitem %></h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">SecondHand</a> | 2023 &copy; CopyRight All Right Reserved. 
                        </div>
                    </div>
                </div>
            </div>
